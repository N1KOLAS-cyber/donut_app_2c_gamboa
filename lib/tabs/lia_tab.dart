...
class LiaTab extends StatelessWidget {
  ...
  final List donutsOnSale = [
    ...
    ["Marzipan"," Krispy Kreme","36",Colors.blue,"lib/images/icecream_donut.png"],
    ["Mamey","Dunkin Donuts","45",Colors.red,"lib/images/strawberry_donut.png"],
    ["Blackberry","Aurrerá","84",Colors.purple,"lib/images/grape_donut.png"],
    ["Nutella", "Costco", "95", Colors.brown, "lib/images/chocolate_donut.png"],
  ];

  // Constructor que recibe la función de callback
  LiaTab({super.key, required this.onAdd});
